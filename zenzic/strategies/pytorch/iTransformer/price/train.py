...
def find_st_trial(st_checkpoit_dir: str):
    # e.g. C:\Trading\iTransformer\2023-12-27\iTransPrice-2024-01-01-18-17-39-789\0\checkpoints
...
def main():
    ...
    if checkpoint_exists:
        model = iTransPrice.load_from_checkpoint(checkpoint_file, configs=args)
    else:
        model = iTransPrice(args)
    ...
    save_model = ModelCheckpoint(
        ...
        filename="iTransPrice-{epoch:03d}-{val_loss:.6f}",
        save_top_k=3,
        mode="min",
